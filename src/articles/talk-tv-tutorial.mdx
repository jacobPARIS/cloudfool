---
title: Talk TV Tutorial: Watch Youtube Streams and Chat with React
...
```js numbered
function Preloader() {
  const [isGoogleReady, setGoogleReady] = React.useState(false)
...
export function Loading() {
  return (
    <Container>
      <Loader type="Bars" color={Theme.primary} height={100} width={100} />
    </Container>
  )
}
```
