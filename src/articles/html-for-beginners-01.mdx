...
`<li>`
: A list item. These are the only thing that can be inside lists, an in a `<ul>` this will show up as a single bullet item.
...
<html>
  ...
  <body>
    ...
    <p>
      I love being able to go to new places and see new things. As soon as I
      don't have somewhere to be for work, you'll find me headed to the airport
      with my suitcase in hand.
    </p>

    <p>There are three reasons I like to travel:</p>
