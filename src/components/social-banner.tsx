    ...
    <div {...props}>
      <div className="max-w-screen-xl px-4 mx-auto sm:px-6 lg:px-6">
        <div className="grid grid-cols-2 mb-10 text-center sm:mb-0 sm:max-w-3xl sm:mx-auto sm:grid-cols-4 sm:gap-8">
          <a
            className="flex flex-col items-center mt-10 text-red-500 hover:text-red-700 sm:mt-0"
          ...
          >
            ...
            <div className="mt-3 text-lg font-medium leading-6">GitHub</div>
          </a>
          ...
          >
            ...
            <div className="mt-3 text-lg font-medium leading-6">Twitter</div>
          </a>
          ...
          >
            ...
            <div className="mt-3 text-lg font-medium leading-6">Instagram</div>
          </a>
          ...
          >
            ...
            <div className="mt-3 text-lg font-medium leading-6">LinkedIn</div>
          </a>
        </div>
      </div>
    </div>
