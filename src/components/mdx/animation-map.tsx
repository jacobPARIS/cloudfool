...
function useTimer(cadence = 1000) {
      ...
      <div className="flex-grow max-w-2xl mx-auto">
        <Window
          ...
          titleElement={() => (
            <div className="flex items-center justify-between px-4 py-1 m-0 mx-auto text-white font-500">
              <p className="px-2 text-lg text-blue-100 opacity-50">JS</p>

              <h2 className="flex-grow text-lg text-center text-blue-100 font-500 px-4">
                Map a string to an object
              </h2>

              <p className="px-2 text-lg text-blue-100 opacity-50">
          ...
          footerElement={() => (
            <div className="flex items-center justify-end px-4 mx-auto text-gray-500 font-500">
              <p className="text-lg">
                <a
                  href="https://twitter.com/intent/follow?screen_name=jacobmparis"
                  rel="noopener"
                  target="twitter"
                  className="text-blue-100 opacity-50 hover:opacity-100 hover:text-blue-300"
                >
                  @jacobmparis
                </a>
              </p>
        ...
        >
          <div>
            ...
            <div style={{backgroundColor: ''}} className="whitespace-pre-wrap">
              ...
              <span className="relative">
                <span className="absolute inset-x-0 -top-0.5">
                  {step === 0 ? (
                    <span
          ...
          <div className="absolute bottom-0 right-0 p-4">
            <div className="px-4 py-2 bg-gray-900 rounded-md bg-opacity-80">
              <div
                style={{backgroundColor: ''}}
                className="whitespace-pre-wrap"
              >
...
function Window({
  ...
  return (
    <div className=" px-14 py-6" style={{backgroundColor: '#73669e'}}>
      <div className="w-full rounded shadow-md">
        ...
        {/* Control height here  */}
        <div
          className="relative w-full h-80 sm:h-40"
          style={{
        ...
        <footer
          className="h-8 rounded-bl rounded-br"
          style={{
