      ...
      <ul className="flex flex-row gap-8">
        <li>
          ...
          >
            ...
            <span className="mx-2 font-medium leading-6">GitHub</span>
          </a>
        </li>
        ...
        <li>
          ...
          >
            ...
            <span className="mx-2 font-medium leading-6">Twitter</span>
          </a>
        </li>
        ...
        <li>
          ...
          >
            ...
            <span className="mx-2 font-medium leading-6">Instagram</span>
          </a>
        </li>
        ...
        <li>
          ...
          >
            ...
            <span className="mx-2 font-medium leading-6">LinkedIn</span>
          </a>
        </li>
      </ul>
    </div>
